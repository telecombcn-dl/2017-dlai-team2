...
from train_with_map import extract_map, create_model, is_valid_track_code, INPUT_WIDTH, INPUT_HEIGHT, INPUT_CHANNELS, XMIN, XMAX, YMIN, YMAX, MAP_HEIGHT, MAP_WIDTH, INPUT_CHANNELS_MAP
