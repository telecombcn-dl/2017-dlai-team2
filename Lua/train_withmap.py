...
def load_training_data(track):
    ...
    if track == 'all':
        ...
        recordings = glob.iglob("/home/epallas/workspace/recordings/LR/*/*".format(track))
        print "recordings/{}/*/*".format(track)
    idx = 0
    for recording in recordings:
        ...
        assert len(filenames) == len(steering), "For recording %s, the number of steering values does not match the number of i                                                                                                                                                mages." % recording
