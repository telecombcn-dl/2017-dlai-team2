...
from train_original_with_lstm import create_model, is_valid_track_code, INPUT_WIDTH, INPUT_HEIGHT, INPUT_CHANNELS
...
def prepare_image(im):
    ...
    im_arr = im_arr.reshape(1,1, INPUT_HEIGHT, INPUT_WIDTH, INPUT_CHANNELS)
    return im_arr
...
if __name__ == "__main__":
    ...
    model = create_model(keep_prob=1, batch_size = 1)
